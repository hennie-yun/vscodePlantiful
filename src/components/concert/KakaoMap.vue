...
export default {
    ...
    methods : {
        relay() {
            ...
            self.$axios('https://dapi.kakao.com/v2/local/search/keyword.json?autoload=false&query='+this.propsdata, {
                headers : {
                    'Authorization' : 'KakaoAK b0db0bd9fab741fdabe06937163b912e'
                }
            }).then((result) => {
