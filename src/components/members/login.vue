        ...
        <div class="card bg-white text-black" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            <div class="mb-md-5 mt-md-4 pb-5">
              <h2 class="fw-bold mb-2">Plantiful</h2>
              <br/>
              ...
              <button class="btn btn-primary btn-lg" style="border: none; background-color: #7AC6FF;" v-on:click="login" >Login</button>
...
export default {
    ...
    methods:{
        login(){
            ...
            self.$axios.post('/members/login', form)
            .then(function(res){
                if(res.status==200){
                    if(res.data.flag){
